...
if vol_model==1
    ...
    cov_model=cov_model_estimation(mean_model,rf, subfolder);
    % Simulate risk factors
    risk_factor_sim=risk_factor_simulation_boot_vol(ref_date,end_date,numscenarios,rf,mean_model,cov_model,w, subfolder);
else
    risk_factor_sim=risk_factor_simulation_boot_nonvol(ref_date,end_date,numscenarios,rf,mean_model,w, subfolder);
end
